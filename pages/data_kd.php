<?php
	...
	//SELECT `id`, `bulan`, `tahun`, `jumlah` FROM `kebutuhan_bandwidth` WHERE 1
		$qrySelect = "SELECT * FROM tb_kd WHERE  nama_kd = '".$_POST['nama_kd']."' and tahun = '".$_POST['tahun']."'";
		$qrySelect2 = mysqli_query($conn,$qrySelect);
		$count = mysqli_num_rows($qrySelect2);
		if($count == 0){
			$qry = "INSERT INTO tb_kd(nama_kd, tahun) VALUES ('".$_POST['nama_kd']."','".$_POST['tahun']."')";
	...
	if(isset($_POST['hapus']) && isset($_POST['id_kd'])){
		$qryD = "DELETE FROM tb_kd WHERE id_kd = ".$_POST['id_kd'];
...
<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">.:: Data Kompetensi Dasar ::.<!-- Button trigger modal -->
    ...
    <div class="modal fade" id="addSurvey" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="?content=Data_KD" method="POST">
                    ...
                    <div class="modal-body">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="form-control"  placeholder="Nama KD"  name="nama_kd" type="text" required>
                                <br>

                                <label>Tahun:</label>
                                <input class="form-control"  placeholder="Tahun"  name="tahun" type="text" required>
                                <br>
                            </div>
                        </fieldset>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    <thead>
                        <tr>
                            ...
                            <th><center>Nama Kompetensi Dasar</center></th>
                        ...
                        <?php
                            ...
                            while($data = mysqli_fetch_array($qry2)){
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo $data['nama_kd'] ?></td>
                                    <td align="center"><?php echo $data['tahun'] ?></td>
                                    <td>
                                        <center>
                                            <button class='btn btn-warning' data-toggle='modal' data-target="#edits<?php echo $data['id_kd'] ?>"><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></button>
                                            <button class='btn btn-danger' data-toggle='modal' data-target="#hapus<?php echo $data['id_kd'] ?>"><span class='fa fa-trash' aria-hidden='true'></span></button>
                                        </center>
                                    </td>
                                    ...
                                    <!-- hapus --->
                                    <div class="modal fade" id="hapus<?php echo $data['id_kd']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="?content=Data_KD" method="POST">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <fieldset>
                                                            <div class="form-group">
                                                                    <input type="hidden" name="id_kd" value="<?php echo $data['id_kd']; ?>">
